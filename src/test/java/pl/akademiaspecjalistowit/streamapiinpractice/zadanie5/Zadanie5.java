...
public class Zadanie5 {
    ...
    void zadanie5() {
        ...
        //when
        Map<String, List<String>> productsGroupedByCategory = findProductsMoreExpensiveThan(products);
        //then
    ...
    private Map<String, List<String>> findProductsMoreExpensiveThan(List<Product> products) {
        return products
                .stream()
